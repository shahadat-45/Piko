    ...
    <div class="container">
        <div class="upcoming-offer">
            ...
            <div class="left-image">
                <img src="{{ asset('TheMart') }}/assets/images/upcomming-left.png" alt="">
            </div>
            ...
            <div class="right-image">
                <img src="{{ asset('TheMart') }}/assets/images/upcomming-right.png" alt="">
            </div>
...
<section class="themart-trendingproduct-section section-padding">
    <div class="container">
        ...
        <div class="trendin-slider owl-carousel">
            ...
            <div class="product-item">
                <div class="image">
                    <img src="{{ asset('TheMart') }}/assets/images/trending-product/3.png" alt="">
                    <div class="tag new">New</div>
                </div>
                <div class="text">
            ...
            <div class="product-item">
                <div class="image">
                    <img src="{{ asset('TheMart') }}/assets/images/trending-product/4.png" alt="">
                    <div class="tag sale">Sale</div>
                </div>
                <div class="text">
            ...
            <div class="product-item">
                <div class="image">
                    <img src="{{ asset('TheMart') }}/assets/images/trending-product/5.png" alt="">
                    <div class="tag new">New</div>
